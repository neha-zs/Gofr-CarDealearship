...
func (m *MockCar) CreateCar(ctx *gofr.Context, car *models.Car) (models.Car, error) {
	m.ctrl.T.Helper()
...
func (m *MockCar) DeleteCar(ctx *gofr.Context, id string) error {
	m.ctrl.T.Helper()
...
func (m *MockCar) GetCarByID(ctx *gofr.Context, id string) (models.Car, error) {
	m.ctrl.T.Helper()
...
func (m *MockCar) GetCarsByBrand(ctx *gofr.Context, brand string) ([]models.Car, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetCarsByBrand", ctx, brand)
	ret0, _ := ret[0].([]models.Car)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (mr *MockCarMockRecorder) GetCarsByBrand(ctx, brand interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetCarsByBrand", reflect.TypeOf((*MockCar)(nil).GetCarsByBrand), ctx, brand)
}

// UpdateCar mocks base method.
func (m *MockCar) UpdateCar(ctx *gofr.Context, id string, car *models.Car) (models.Car, error) {
	m.ctrl.T.Helper()
...
func (m *MockEngine) EngineCreate(ctx *gofr.Context, engine *models.Engine) (models.Engine, error) {
	m.ctrl.T.Helper()
...
func (m *MockEngine) EngineDelete(ctx *gofr.Context, id string) error {
	m.ctrl.T.Helper()
...
func (m *MockEngine) EngineGetByID(ctx *gofr.Context, id string) (models.Engine, error) {
	m.ctrl.T.Helper()
...
func (m *MockEngine) EngineUpdate(ctx *gofr.Context, id string, engine *models.Engine) (models.Engine, error) {
	m.ctrl.T.Helper()
